...
function useActiveNavItem(): {
  ...
  const isTasksPage = !isExtensionRoute && (leaf === "automations" || location.pathname.startsWith("/automations"));
  const isBoardPage =
    !isExtensionRoute && (leaf === "board" || location.pathname.startsWith("/board") || location.pathname.startsWith("/tasks"));
  const isNewTaskPage =
    !isExtensionRoute && (leaf === "new" || location.pathname.startsWith("/new") || location.pathname === "/tasks/new");
  const isReviewsPage =
    !isExtensionRoute && (leaf === "reviews" || location.pathname.startsWith("/reviews"));
            ...
            tab; onNavClick still closes the sidebar on a plain mobile tap. */}
              ...
              <Button
                ...
                className={cn(
                  ...
                  "w-full justify-start border-0 font-normal",
                  SIDEBAR_HOVER_HIGHLIGHT,
                  isBoardPage && SIDEBAR_ACTIVE_HIGHLIGHT,
                )}
                variant="ghost"
                data-testid="board-nav"
              >
                <Link to="/board" onClick={onNavClick} componentId="sidebar.board">
                  <Columns3Icon
                    className={cn(
                      "ui-icon",
                      isBoardPage
              ...
              <Button
                ...
                className={cn(
                  ...
                  "w-full justify-start border-0 font-normal",
                  SIDEBAR_HOVER_HIGHLIGHT,
                  isNewTaskPage && SIDEBAR_ACTIVE_HIGHLIGHT,
                )}
                variant="ghost"
                data-testid="new-task-nav"
              >
                <Link to="/new" onClick={onNavClick} componentId="sidebar.new_task">
                  <PlusCircleIcon
                    className={cn(
                      "ui-icon",
                      isNewTaskPage
              ...
              <Button
                ...
                className={cn(
                  ...
                  "w-full justify-start border-0 font-normal",
                  SIDEBAR_HOVER_HIGHLIGHT,
                  isReviewsPage && SIDEBAR_ACTIVE_HIGHLIGHT,
                )}
                variant="ghost"
                data-testid="reviews-nav"
              >
                <Link to="/reviews" onClick={onNavClick} componentId="sidebar.reviews">
                  <ClipboardCheckIcon
                    className={cn(
                      "ui-icon",
                      isReviewsPage
                  ...
                  {reviewCount > 0 && (
                    <span
                      aria-label={`${reviewCount} reviews waiting`}
                      className={cn(
                        ...
                        isReviewsPage ? "bg-transparent" : "bg-[var(--sidebar-active)]",
                      )}
                    >
                      {reviewCount}
                    </span>
              ...
              >
                <Link to="/automations" onClick={onNavClick} componentId="sidebar.tasks">
                  <ClockIcon
                    className={cn(
                      "ui-icon",
                      isTasksPage
